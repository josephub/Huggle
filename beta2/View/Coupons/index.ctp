<div class="coupons index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('taggingId');?></th>
			<th><?php echo $this->Paginator->sort('isAvailed');?></th>
	...
	<tr>
		...
		<td><?php echo h($coupon['Coupon']['taggingId']); ?>&nbsp;</td>
		<td><?php echo h($coupon['Coupon']['isAvailed']); ?>&nbsp;</td>
		<td><?php echo h($coupon['Coupon']['campaignId']); ?>&nbsp;</td>
		<td class="actions">
